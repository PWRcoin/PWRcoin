...
bitcoin up-to-date.  Just type
  ...
  sudo apt-get update
in your terminal, then install the pwrcoin-qt package:
  sudo apt-get install pwrcoin-qt
...
* (Windows only): enable ASLR and DEP for pwrcoin-qt.exe
* (Windows only): add meta-data to pwrcoin-qt.exe (e.g. description)
