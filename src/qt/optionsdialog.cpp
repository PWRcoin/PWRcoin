    ...
    mapper(nullptr)
{
    ...
    ui->PWRcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->PWRcoinAtStartup);
    ...
    ui->PWRcoinAtStartup->setToolTip(ui->PWRcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->PWRcoinAtStartup->setText(ui->PWRcoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->PWRcoinAtStartup, OptionsModel::StartAtStartup);
